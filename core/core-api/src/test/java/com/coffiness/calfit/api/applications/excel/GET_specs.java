...
public class GET_specs {
  ...
  void hr_can_download_applicant_excel(
      ...
      @Autowired ApplicationRepository applicationRepository) throws Exception {
    // Arrange
  ...
  void applicant_cannot_download_applicant_excel(
    ...
    assertThat(response.getBody()).isNotNull();
    assertThat(new String(response.getBody(), StandardCharsets.UTF_8)).contains("\"code\":\"E401\"");
  }
