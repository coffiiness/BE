...
public class MeetingRoomService {
  ...
  public MeetingRoom update(Long id, String name, Integer capacity) {
    ...
    Optional<MeetingRoomEntity> duplicated = meetingRoomRepository.findByName(name);
  ...
  public List<MeetingRoom> list() {
    ...
    List<MeetingRoomEntity> entities = meetingRoomRepository.findAllByOrderByNameAsc();
