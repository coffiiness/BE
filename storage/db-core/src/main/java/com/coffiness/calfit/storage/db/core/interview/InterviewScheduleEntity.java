...
public class InterviewScheduleEntity extends TenantBaseEntity {
    ...
    public InterviewScheduleEntity(Long recruitmentId, Long recruitmentStageId, Long meetingRoomId,
            LocalDateTime scheduledAt, Integer durationMinutes, String memo, InterviewStatus status) {
